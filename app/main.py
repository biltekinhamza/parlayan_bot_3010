...
APP_VERSION = "1.4.6.1-professional-paper-v4.6.1"
...
async def lifespan(app: FastAPI):
    ...
    session = start_paper_session(config_snapshot=config, strategy_version=config.get("app", {}).get("strategy_version", "professional_paper_v461"))
